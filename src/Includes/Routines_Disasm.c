...
#ifndef BEA_LIGHT_DISASSEMBLY
    if (GV.OperandSize == 64) {
      (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.16llX", (Int64) *((Int32*) (
          GV.EIP_ - 4)));
    }
    else {
      (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.8X", (Int64) *((UInt32*) (
          GV.EIP_ - 4)));
    }
#endif
...
#ifndef BEA_LIGHT_DISASSEMBLY
    (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.4X", (Int64) *((UInt16*) (GV.EIP_
                                                                                                                 - 2)));
#endif
    pMyDisasm->Operand2.OpType = CONSTANT_TYPE + ABSOLUTE_;
...
void __bea_callspec__ EvIb (PDISASM pMyDisasm) {
  ...
  if (GV.OperandSize >= 32) {
    ...
    if (GV.OperandSize == 32) {
      ...
      if (MyNumber > 0) {
        (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.2X", (Int64) *((Int8*) (
            GV.EIP_ - 1)));
      }
      else {
        (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.8X", (Int64) *((Int8*) (
            GV.EIP_ - 1)));
      }
#endif
    }
      ...
      if (MyNumber > 0) {
        ...
        (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.16llX", (Int64) *((Int8*) (
            GV.EIP_ - 1)));
      }
#endif
    }
    ...
    if (!Security (0, pMyDisasm)) return;
#ifndef BEA_LIGHT_DISASSEMBLY
    (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.4X", (Int64) *((Int8*) (GV.EIP_
                                                                                                               - 1)));
#endif
    pMyDisasm->Instruction.Immediat = *((UInt8*) (GV.EIP_ - 1));
  }
...
void __bea_callspec__ EbIb (PDISASM pMyDisasm) {
  ...
  if (!Security (0, pMyDisasm)) return;
#ifndef BEA_LIGHT_DISASSEMBLY
  (void) CopyFormattedNumber (pMyDisasm, (char*) &pMyDisasm->Operand2.OpMnemonic, "%.2X", (Int64) *((Int8*) (GV.EIP_
                                                                                                             - 1)));
#endif
  pMyDisasm->Instruction.Immediat = *((UInt8*) (GV.EIP_ - 1));
}
